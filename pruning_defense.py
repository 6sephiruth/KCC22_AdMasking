...
def normal_prunning(model, origin_data, origin_label):
    ...
    pickle.dump(arrange_result, open(f'./model/cifar-10/dataset/pre_pruning/{origin_label}-{origin_label}','wb'))
...
# def cifar10_model_compress(analysis_num ,model, dataset):
def cifar10_model_compress(model, dataset, y_full_data):
